...
const Navbar = ({recupereValeur}) => {
    ...
    return (
        <nav className='fixed z-10 flex justify-between items-center bg-primary w-full h-20 shadow-2xl z-1 border-b-2 border-ColorText'>
            ...
            <SiMusicbrainz size={50} style={{color:"white"}} className="hidde"/>
                <div className="hidden flex">
                    ...
                    <div className='w-[40%]  flex bg-gray-100 rounded-full '>
                        ...
                        <input type="text" className='w-full sm:w-full h-15 bg-inherit outline-none mt-1 rounded-full text-left text-2xl shadow-2xl' onChange={recupereValeur}/>
                    </div>
                <div>
            </div>
