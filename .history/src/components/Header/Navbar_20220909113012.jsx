...
const Navbar = ({recupereValeur}) => {
    ...
    return (
        <nav className='fixed bg-gray-300 sm:fixed z-10 flex justify-between items-center bg-primary w-full h-20 shadow-2xl z-1 border-b-1 border-ColorText'>
            ...
            <SiMusicbrainz size={50} style={{color:"white"}} className="hidden sm:block"/>
                <div className="hidden sm:flex">
                    ...
                    <div className='flex  gap-20 justify-between sm:flex w-[100%] bg-gray-100 rounded-full '>
