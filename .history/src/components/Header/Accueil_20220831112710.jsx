...
const Accueil = () => {
    ...
    const btnStyle='py-2 px-4 bg-green-500 text-white font-semibold rounded-3xlshadow-md mb-4 hover:border-2xl'
    return (
        <div className='flex justify-center items-center mt-40'>
            <div className='w-[30%] bg-gray-900 h-fit flex flex-col gap-10 justify-center items-center rounded-xl shadow-2xl'>
                ...
                <div>
                   ...
                   <a href={`${AUTH_ENDPOINT}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=${RESPONSE_TYPE}`} className={btn}>
                    Login to Spotify</a>
                </div>
            </div>
        </div>
