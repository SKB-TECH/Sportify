...
const Sidbar = () => {
  ...
  return (
    <div className="flex">
        <div className={` ${open ? 'w-72':'w-20'} duration-300 bg-primary h-screen mt-20 relative flex flex-col gap-7 hover:bg-gray-600 `}>
            ...
            {menu.map((item, index) => (
                        <div className="flex gap-2  ml-5 rounded mt-10 space-x-2 " key={index}>
