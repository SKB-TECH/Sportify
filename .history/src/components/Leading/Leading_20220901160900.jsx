    ...
    return (
        <>
            ...
            <div className='flex justify-between '>
               ...
               <div className='flex mt-20 flex-wrap justify-center items-center flex-gap-5  w-25 h-1.5'> 
                {
                   music.map((item,index)=>(
                    <div key={index} className='flex-col justify-center items-center bg-gray-200 rounded-lg shadow-2xl ml-5'> 
                         <img src={item.images[1]?.url} alt="" className='m-2 text-lg' sizes='20px'/>
                         <span>{item.name} </span> 
                    </div>
                   ))
                }
