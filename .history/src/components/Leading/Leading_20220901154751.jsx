    ...
    return (
        <>
            ...
            <div className='flex justify-between '>
               ...
               <div className='w-full mt-20 flex-wrap flex flex-gap-5 justify-center items-center'> 
                {
                   music.map((item,index)=>(
                    
                    <div key={index} className='w-60 h-48 bg-gray-200 rounded-lg shadow-2xl ml-5 mt-10 '> 
                         <img src={item.images[1]?.url} alt="" className='text-xl w-[80%]] h-40 text-center'/>
                         <span>{item.name} </span> 
                    </div>
                   ))
                }
