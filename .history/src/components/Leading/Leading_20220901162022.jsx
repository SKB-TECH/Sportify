    ...
    return (
        <>
            ...
            <div className='flex justify-between '>
               ...
               <div className='flex mt-20 flex-wrap justify-center items-center w-50 h-56 gap-5 '> 
                {
                   music.map((item,index)=>(
                    <div key={index} className='bg-gray-200 rounded-lg shadow-2xl w-20 h-10 '> 
                         <img src={item.images[1]?.url} alt="" sizes='30'/>
                         <span>{item.name} </span> 
                    </div>
                   ))
                }
