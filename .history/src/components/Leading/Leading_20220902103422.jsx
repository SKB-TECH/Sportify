               ...
               <div className='flex ml-80 mt-20 flex-wrap w-50 h-10 gap-5 '> 
                {
                   music.map((item,index)=>(
                    ...
                    <div key={index} className='bg-gray-200 w-[20%] rounded h-52 shadow-2xl ml-5 overflow-hidden mt-5 p-3 hover:'> 
                         ...
                         <span className='text-xl'>{item.name} </span> 
                            ...
                            <div className='w-[100%] z-10 top-[-190px] h-56  relative opacity-0 hover:opacity-100 bg-green-100' >
                                <AiFillPlayCircle />
                               </div>
