               ...
               <div className='flex ml-80 mt-20 flex-wrap w-50 h-10 gap-5 '> 
                {
                   music.map((item,index)=>(
                    ...
                    <div key={index} className='bg-gray-200 w-[20%] rounded h-60 shadow-2xl ml-5 overflow-hidden mt-5 p-3 hover:'> 
                         ...
                         <span className='text-xl'>{item.name} </span> 
                            ...
                            <div className='w-[100%] z-10 top-[-100px] h-56  relative opacity-0  hover:opacity-100 hover:top-[-100px] transition-all delay-150 ' >
                                <AiFillPlayCircle size={70} className='absolute top-36 left-48  ' />
                               </div>
