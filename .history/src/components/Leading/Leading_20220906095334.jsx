...
const Leading = () => {
        ...
        const {visible,setVisible,tokens,setTokens,music,setMusics,categori,setCategori}=useContext(StateContext)
        ...
        return (
            <>
                ...
                <div className='fixed'>
                 ...
                 <div className='flex ml-80 mt-20 flex-wrap w-50 h-10 gap-5 ' onClick={()=>setVisible(false)}> 
                    
                    {
                        chansons.map((item,index)=>(
                         //lors les categories sont soite albums ou tracks 
                             categori ==="albums"|| "tracks" ?(

                                <Card 
                                    key={index} artist={item.name}
                                    url={item.href}
                                    icon={
