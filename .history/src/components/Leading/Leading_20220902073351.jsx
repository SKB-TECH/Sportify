    ...
    return (
        <>
            ...
            <div className='flex justify-between '>
               ...
               <div className='ml-80 mt-20 flex-wrap w-15 h-10 gap-5 '> 
                {
                   music.map((item,index)=>(
                    <div key={index} className='bg-gray-200 grid-cols-4 col-span-4 rounded-lg shadow-2xl ml-5 overflow-hidden'> 
